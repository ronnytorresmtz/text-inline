...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-text-inline', __webpack_require__(4));
  Vue.component('detail-text-inline', __webpack_require__(7));
  Vue.component('form-text-inline', __webpack_require__(10));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    submit: function submit() {
      ...
      return Nova.request().post('/nova-api/' + this.resourceName + '/' + this.$parent.resource.id.value, formData).then(function () {
        var valuMsg = _this2.field.value.length > 20 ? _this2.field.value.substring(0, 20) + ' ...' : _this2.field.value;
        _this2.$toasted.show(_this2.field.name + ' updated to ' + valuMsg, {
          type: 'success'
        });
      }, function (response) {
        return _this2.$toasted.show(response, { type: 'error' });
      });
    },
  ...
  computed: {
    ...
    listener: function listener() {
      ...
      var event = this.field.event.split('.');
      var name = event[0];
      var modifier = event[1] ? this.capitalize(event[1]) : null;
      return _defineProperty({}, name, function (e) {
        if (_this3.valueWasNotChanged) return;
        if (modifier && modifier === e.key) _this3.submit();
        if (!modifier) _this3.submit();
      });
    },
    valueWasNotChanged: function valueWasNotChanged() {
...
var render = function() {
  ...
  return _c("div", [
    _vm.field.inlineOnIndex && _vm.isEditable
      ? _c(
          "input",
          _vm._g(
            {
      ...
      : _c(
          "span",
          {
            class:
              "whitespace-no-wrap " +
              (_vm.field.inlineOnIndex ? "cursor-pointer" : "cursor-default"),
            on: {
